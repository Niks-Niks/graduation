...
import com.graduation.web.dish.DishRestController;
...
public class DishRepositoryTest extends AbstractRepositoryTest {
    ...
    void get() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "/dish/" + DISH_ID)
    ...
    void getNotFound() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "/dish/" + NOT_FOUND)
                .with(userHttpBasic(admin)))
                .andDo(print())
    ...
    void delete() throws Exception {
        perform(MockMvcRequestBuilders.delete(REST_URL + "/dish/" + DISH_ID)
                .with(userHttpBasic(admin)))
    ...
    void deleteNotFound() throws Exception {
        perform(MockMvcRequestBuilders.delete(REST_URL + "/dish/" + NOT_FOUND)
                .with(userHttpBasic(admin)))
                .andExpect(status().isUnprocessableEntity());
    }
    ...
    void update() throws Exception {
        ...
        perform(MockMvcRequestBuilders.put(REST_URL + "/dish/" + DISH_ID).contentType(MediaType.APPLICATION_JSON)
    ...
    void createWithLocation() throws Exception {
        Dish newDish = getNew();
        ResultActions action = perform(MockMvcRequestBuilders.post(REST_URL + "dish" + DISH_ID)
